...
const newDetail = {
    ...
    comments: [
        {
            name: "حسین",
            comment: "Miusov, as a man man of breeding and deilcacy, could not but feel some inwrd qualms, when he reached the Father Superior's with Ivan: he felt ashamed of havin lost his temper. He felt that he ought to have disdaimed that despicable wretch, Fyodor Pavlovitch, too much to have been upset by him in Father Zossima's cell, and so to have forgotten ",
            date: '12/23'
        },
        {
            name: "مهدی",
            comment: " he reached the Father Superior's with Ivan: he felt ashamed of havin lost his temper. He felt that he ought to have disdaimed that despicable wretch, Fyodor Pavlovitch, too much to have been upset by him in Father Zossima's cell, and so to have forgotten ",
            date: '12/23'
        },
        {
            name: "مهدی",
            comment: "Miusov, as a man man of breeding and deilcacy, could not but feel some inwrd qualms, when he reached the Father Superior's with Ivan: he felt ashamed of havin lost his temper. He felt that he ought to have disdaimed that ave forgotten ",
            date: '12/23'
        },
        {
            name: "مهدی",
...
class App extends Component {
    ...
    get_data(){
        ...
        axios.get(url).then(response => {
            ...
            newDetail:response.data['newDetail'],
            get:true
        })
